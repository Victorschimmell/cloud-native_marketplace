...
public sealed record OrderResponse
{
    ...
    public DateTimeOffset? OrderApprovedAtUtc { get; init; }
    public DateTimeOffset? OrderDeliveredCarrierDateUtc { get; init; }
    public DateTimeOffset? OrderDeliveredCustomerDateUtc { get; init; }
    public DateTimeOffset? OrderEstimatedDeliveryDateUtc { get; init; }
    public required decimal SubtotalAmount { get; init; }
    public required decimal FreightAmount { get; init; }
    public required decimal TotalAmount { get; init; }
    public required string CurrencyCode { get; init; }
    public Guid? PlacedFromCartId { get; init; }
