...
{
    public static App.AddCartItemRequest ToApplicationRequest(this AddCartItemRequest request, Guid? authenticatedUserId = null) =>
        new(request.CartId, authenticatedUserId ?? request.UserId, request.SessionId, request.ListingId, request.Quantity);

    public static App.UpdateCartItemRequest ToApplicationRequest(this UpdateCartItemRequest request, Guid listingId, Guid? authenticatedUserId = null) =>
        new(request.CartId, authenticatedUserId ?? request.UserId, request.SessionId, listingId, request.Quantity);
