...
public sealed class ServiceConstructorTests
{
    ...
    {
        Assert.Throws<ArgumentNullException>(() => new AuthService(new FakeUserAccountRepository(), null!, new FakeAuthTokenGenerator(), new FakeDateTimeProvider()));
    }
    ...
    public void Application_Services_Can_Be_Constructed_With_Application_Only_Fakes()
    {
        ...
        var paymentService = new PaymentService(new FakePaymentRepository(), new FakeOrderRepository(), new FakeDateTimeProvider(), new FakeUnitOfWork());
        ...
        _ = new CheckoutService(new FakeCartRepository(), new FakeOrderRepository(), new FakeOrderNumberRepository(), new FakeCustomerRepository(), paymentService, new FakeDateTimeProvider(), new FakeCurrencyConversionService(), new FakeUnitOfWork());
        ...
        _ = new RegistrationService(new FakeUserAccountRepository(), new FakeCustomerRepository(), new FakeSellerRepository(), new FakePasswordHasher());
